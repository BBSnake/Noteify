...
public class ItemsActivity extends NoteifyActivity implements IView<ItemDTO> {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.del_all:
                builder = new AlertDialog.Builder(ItemsActivity.this, R.style.Theme_AppCompat_Light_Dialog_Alert);
                builder.setMessage(R.string.item_del_all_q).setTitle(R.string.delete_all)
                        .setPositiveButton(getString(R.string.ok), new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                presenter.attemptDeleteAll(categoryId, itemDAO);
                                dialog.dismiss();
                            }
                ...
                return true;
            case R.id.del_all_mark:
                builder = new AlertDialog.Builder(ItemsActivity.this, R.style.Theme_AppCompat_Light_Dialog_Alert);
                builder.setMessage(R.string.item_del_all_mark_q).setTitle(R.string.delete_all_marked)
                        .setPositiveButton(getString(R.string.ok), new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                presenter.attemptDeleteAllMarked(categoryId,itemDAO);
                                dialog.dismiss();
                            }
                        }).setNegativeButton(getString(R.string.cancel), new DialogInterface.OnClickListener() {
                    @Override
    ...
    public void onSuccessDeleteAll() {
        showSnackbar(fab, getString(R.string.item_all_deleted), ContextCompat.getColor(this, R.color.colorPrimary));
        presenter.attemptSelect(categoryId,itemDAO);
        mAdapter.refresh(items);
    }
    ...
    public void onSuccessDeleteAllMark() {
        showSnackbar(fab, getString(R.string.item_all_mark_deleted), ContextCompat.getColor(this, R.color.colorPrimary));
        presenter.attemptSelect(categoryId,itemDAO);
        mAdapter.refresh(items);
    }
